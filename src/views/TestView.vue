  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <button type="button" class="btn btn-secondary" @click="listDevices()">
          List
        </button>&nbsp;
        <button type="button" class="btn btn-secondary" @click="addDevice()">
          Add
        </button>&nbsp;
        <button type="button" class="btn btn-secondary" @click="deleteDevice()">
          Delete
        </button>&nbsp;
        <button type="button" class="btn btn-secondary" @click="updateDevice()">
          Update
        </button>&nbsp;
        <button type="button" class="btn btn-secondary" @click="searchDevice()">
          MDNS
        </button>&nbsp;
        <button type="button" class="btn btn-secondary" @click="proxyDevice()">
          Proxy
        </button>&nbsp;
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <button type="button" class="btn btn-secondary" @click="listBatches()">
          List
        </button>&nbsp;
        <button type="button" class="btn btn-secondary" @click="addBatch()">
          Add
        </button>&nbsp;
        <button type="button" class="btn btn-secondary" @click="deleteBatch()">
          Delete
        </button>&nbsp;
        <button type="button" class="btn btn-secondary" @click="updateBatch()">
          Update
        </button>&nbsp;
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <button type="button" class="btn btn-secondary" @click="listGravity()">
          List
        </button>&nbsp;
        <button type="button" class="btn btn-secondary" @click="addGravity()">
          Add
        </button>&nbsp;
      </div>
    </div>
...
import { Gravity } from '@/modules/gravityStore'
...
function addDevice() {
  ...
  const device = new Device(0, id, "esp32", "gravmon", "hostname", "<config>", "pink", "http://localhost", "generated device")
...
function addBatch() {
  ...
  const batch = new Batch(0, "name", "description", "AAAAAA", true, "20240101", "IPA", "MP", 1.0, 2.0, 3.0, "")
